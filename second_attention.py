...
the_text += "「デレマス朝の天気予報」に続き、本日から「デレマス夜の天気予報」が始まります！\n"
the_text += "夜の天気予報は東京だけでなく、仙台、大阪、福岡の3箇所が追加される上に、新たに依田芳乃、鷺沢文香、橘ありす、"
the_text += "櫻井桃華の４人が予報するアイドルに追加されました♪\n今後も天気予報をしっかりみてお仕事頑張ってくださいね！\n#デレマス夜の天気予報"
