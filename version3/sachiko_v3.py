...
class Sachiko:
    def __init__(self,am_pm,japan,prediction,cond,s_data):
        ...
        self.d_text["under0"] = [
            ...
            '湯けむり温泉郷にたたずむボク…とってもエキゾチックでカワイイですね。'
            ]
        self.d_text["over30"] = [
        ...
        self.d_text["snow_1-10"] = [
            "{}はさらに雪が積もりそうでねえ。スキーの練習をしましょう。".format(date),
            '犬ぞり体験楽しかったです♪転んで雪まみれだったんですけどねー'
            ]
        #雪が降る＆まあまあの積雪
        self.d_text["snow_1-1"] = [
            "{}はさらに雪が積もりそうですよ！ふふーん！".format(date),
            'なんて綺麗なオーロラ…ボクでも見とれてしまいます'
            ]
        #雪が降る＆積雪なし
        self.d_text["snow_1-0"] = [
            '雪よりも華麗に舞うのは…ボク！',
            "別にボクは雪が降ったぐらいじゃしゃぎませんよ。フフーン！"
            ]
        #雪が降らん＆積雪が十分にある
        ...
        self.d_text['special'] = [
            'みなさんおみくじは引きましたか？まあ、ボクは当然大吉ですけどねー♪',
            'え？誰にチョコを渡すかって？…そ、それは……',
            'ふふーん！もちろん、ボクがお雛様ですよ。',
